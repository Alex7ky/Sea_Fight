...
/*
        Поиск порта
                ...
                FPLEN   - длина отрезка проверяемых портов
*/
#define FPSTART 1120
#define FPLEN 10000
/*
        SERVER_S - информация о сервере
                ...
                client_1        - дескриптор потока данных для первого клиента
                client_2        - дескриптор потока данных для второго клиента
                fl_log          - значение болшьше нуля = выводить лог в консоль
                log_d           - дескриптор файла лога
